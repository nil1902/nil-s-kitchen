...
const testimonials: Testimonial[] = [
  {
    ...
    content:
      "Nil's Kitchen is my new go-to spot! Every bite bursts with authentic flavour – you can literally taste the love in each dish.",
  },
  {
    id: "2",
    name: "Rahul Sharma",
    ...
    <section className="w-full bg-gradient-to-b from-white to-amber-50 py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="max-w-2xl mx-auto text-gray-600 mb-10">
          ...
          of our regulars have to say about their experience at Nil's Kitchen.
        </p>
